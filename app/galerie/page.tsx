...
export default function GalleryPage() {
  ...
  return (
    <div className="container-page py-12">
      <h1 className="text-3xl font-black text-brand-dark">Galerie gravel kol</h1>
      <p className="mt-2 max-w-2xl text-gray-600">
        Klikněte na kolo a podívejte se na dostupnost v kalendáři. Vyberte termín a zarezervujte.
      </p>

      {error && (
        <div className="mt-6 rounded-md bg-red-50 p-4 text-sm text-red-700">
          Chyba při načítání kol: {error}
        </div>
      )}
